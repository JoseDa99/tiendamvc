    ...
    <div class="card-body">
        <form action="<?= ROOT ?>adminUser/create/" method="POST">
            <div class="form-group text-left">
                ...
                <input type="text" name="name" class="form-control" placeholder="Escribe tu nombre completo" required value="<?= $data['dataForm']['name'] ?? '' ?>">
            </div>
            <div class="form-group text-left">
                <label for="email">Correo Electrónico:</label>
                <input type="email" name="email" class="form-control" placeholder="Escribe el correo electrónico" required value="<?= $data['dataForm']['email'] ?? '' ?>">
            </div>
            <div class="form-group text-left">
